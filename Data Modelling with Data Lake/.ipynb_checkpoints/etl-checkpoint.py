...
def process_song_data(spark, input_data, output_data):
    """
       Extracts all JSON files from s3 and process the data to extract song and artist tables and load them      back to S3. 
       
       Spark:Connects to the spark session
       
       input_data:S3 Location to access all source data related to song_data
       
       output_data:S3 Location where all the data related to song and artist tables are dropped.
    """
...
def process_log_data(spark, input_data, output_data):
    """
       Extracts all JSON files from s3 and process the data to extract Users,Time and Song_Plays tables and     load them back to S3. 
       
       Spark:Connects to the spark session
       
       input_data:S3 Location to access all source data related to users,time and song_plays
